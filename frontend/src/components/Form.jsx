        ...
        <div className="card2">
          <form className="form">
            ...
            <div className="field">
              ...
              <input type="text" className="input-field" placeholder="Username" autoComplete="off" value={emailId} onChange={(e) => setEmailId(e.target.value)} />
            </div>
            <div className="field">
              <svg viewBox="0 0 16 16" fill="currentColor" height={16} width={16} xmlns="http://www.w3.org/2000/svg" className="input-icon">
            ...
            <div>
              ...
              <button className="button2" onClick={handleSigup}>Sign Up</button>
            </div>
